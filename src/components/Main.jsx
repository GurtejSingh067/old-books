...
const Main = () => {
    return (
        <div className='md:flex md:max-h-[93vh]'>
            ...
            <div className='m-1 p-2 rounded-xl bg-[#e6e1f3] shadow-[-3px_4px_3px_rgba(0,0,0,0.25)] md:overflow-x-scroll'>
                ...
                <div className='p-1 overflow-scroll rounded-xl flex flex-col gap-5'>
