  ...
  return (
    <div>
      <nav className="m-1 p-1 rounded-xl flex justify-between gap-2 bg-[#E8E9EE] shadow-[-3px_4px_3px_rgba(0,0,0,0.25)]">
        ...
        <div className="search h-9.5 p-2 rounded-full flex justify-between bg-[#E9E9F1] shadow-[-3px_4px_3px_rgba(0,0,0,0.25)] sm:w-68 md:w-88 lg:w-120">
        ...
        <div className="buttons flex items-center gap-2">
          <Link
            to='/signin'
            className="w-20 h-9.5 bg-[#EBEBF3] rounded-3xl shadow-[-3px_4px_3px_rgba(0,0,0,0.25)] flex items-center justify-center ">
            Sign In
          </Link>
          <Link
            to='/signup'
