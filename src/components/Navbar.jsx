  ...
  return (
    <div>
      <nav className="m-1 p-1 rounded-xl flex justify-between gap-2 bg-[#E8E9EE] shadow-[-3px_4px_3px_rgba(0,0,0,0.25)]">
        ...
        <div className="search w-48 h-9.5 p-3 rounded-3xl flex justify-between bg-[#E9E9F1] shadow-[-3px_4px_3px_rgba(0,0,0,0.25)] sm:w-68 md:w-88">
          <div className="flex gap-2">
            <img className="size-5 self-center" src="/search.svg" alt="search" />
            <span className="w-auto self-center opacity-30">Search</span>
          </div>
          <img className="size-5 self-center" src="/filter.svg" alt="filter" />
        </div>
